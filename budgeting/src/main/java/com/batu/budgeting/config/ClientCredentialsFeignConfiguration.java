...
@Configuration
public class ClientCredentialsFeignConfiguration {

    @Bean
    public RequestInterceptor oauth2RequestInterceptor(OAuth2AuthorizedClientManager authorizedClientManager) {
        return requestTemplate -> {
            OAuth2AuthorizeRequest request = OAuth2AuthorizeRequest
                    .withClientRegistrationId("keycloak")
                    .principal("budgeting-service")
                    .build();
    ...
    public OAuth2AuthorizedClientManager authorizedClientManager(
        ...
        var provider = org.springframework.security.oauth2.client.OAuth2AuthorizedClientProviderBuilder
                .builder()
                .clientCredentials()
                .build();
