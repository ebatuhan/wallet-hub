...
class OpenApiConfigurationTest {
    ...
    @Test
    void plaidAdapterServiceOpenAPI_whenCreated_shouldExposeServiceMetadataAndBearerAuth() {
        var openApi = new OpenApiConfiguration().plaidAdapterServiceOpenAPI();

        assertThat(openApi.getInfo().getTitle()).isEqualTo("Wallet Hub Plaid Adapter Service API");
