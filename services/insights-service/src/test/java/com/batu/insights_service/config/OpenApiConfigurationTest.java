...
class OpenApiConfigurationTest {
    ...
    @Test
    void insightsServiceOpenAPI_whenCreated_shouldExposeServiceMetadataAndBearerAuth() {
        var openApi = new OpenApiConfiguration().insightsServiceOpenAPI();

        assertThat(openApi.getInfo().getTitle()).isEqualTo("Wallet Hub Insights Service API");
