...
class OpenApiConfigurationTest {
    ...
    @Test
    void budgetingServiceOpenAPI_whenCreated_shouldExposeServiceMetadataAndBearerAuth() {
        var openApi = new OpenApiConfiguration().budgetingServiceOpenAPI();

        assertThat(openApi.getInfo().getTitle()).isEqualTo("Wallet Hub Budgeting Service API");
